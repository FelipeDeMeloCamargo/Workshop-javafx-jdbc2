...
public class DepartmentListControler implements Initializable, DataChangeListener {
	...
	private void initializeNodes() {
		...
		//para atingir a tela até o final
	...
	private void createDialogForm(Department obj,String absoluteName, Stage parentStage) {
		try {
			...
			controller.subscribleDataChanceListener(this);
			...
			dialogStage.initModality(Modality.WINDOW_MODAL);//não deixa acessar a tela de tras se nao preencher os dados da janela na frente
